-- 由于classpath不支持多个sql文件，因此把people也放在这里
-- mysql的sql见：org/springframework/batch/spring-batch-core/4.1.2.RELEASE/spring-batch-core-4.1.2.RELEASE.jar!/org/springframework/batch/core/
